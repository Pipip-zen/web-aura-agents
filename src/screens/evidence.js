...
export function renderEvidence() {
  ...
  container.className = 'w-full max-w-md mx-auto flex flex-col pb-[100px]';
  ...
  container.innerHTML = `
    ...
    <button class="claim-btn w-full bg-secondary/5 border border-secondary rounded-xl p-4 flex items-center justify-between relative overflow-hidden group shadow-sm" data-selected="true">
    ...
    <button class="claim-btn w-full bg-surface-container-lowest border border-outline-variant rounded-xl p-4 flex items-center justify-between relative overflow-hidden group hover:border-outline hover:shadow-sm transition-all" data-selected="false">
    <div class="flex items-center gap-3 relative z-10">
    ...
    <div class="w-full rounded-2xl border-2 border-dashed border-primary/40 bg-primary/5 p-8 flex flex-col items-center justify-center text-center relative overflow-hidden group shadow-sm cursor-pointer hover:bg-primary/10 transition-colors">
    ...
    <div class="fixed bottom-20 md:bottom-0 left-0 w-full px-6 py-6 bg-gradient-to-t from-surface via-surface/90 to-transparent z-40 pb-10 flex justify-center pointer-events-none">
    <button id="evidence-analyze-btn" class="pointer-events-auto w-full max-w-md bg-primary text-on-primary rounded-xl py-4 px-6 flex items-center justify-center gap-2 shadow-lg shadow-primary/30 hover:shadow-xl hover:shadow-primary/40 transition-all group">
  ...
  btns.forEach(btn => {
    btn.addEventListener('click', () => {
      // reset all
      btns.forEach(b => {
        b.className = 'claim-btn w-full bg-surface-container-lowest border border-outline-variant rounded-xl p-4 flex items-center justify-between relative overflow-hidden group hover:border-outline hover:shadow-sm transition-all';
      ...
      // active
      btn.className = 'claim-btn w-full bg-secondary/5 border border-secondary rounded-xl p-4 flex items-center justify-between relative overflow-hidden group shadow-sm';
